...
// expControl  MTSCsi   1  "C:/Users/Administrator/Desktop/LuTesting/20230607_OpenFresco/sevenstory.mtscs"  1 - trialCP  1 - outCP  2
...
/*
    The CsiFactory::newController() method createsand initializes an
    instance of the CsiController class, suited for communications with
    the MTS 793 System Software.Once created, your program can use the
    returned ICsiController interface to get the names of the available
    control channels(with respective control modes), signals, and
    dimensions(and associated units).
*/


// ???  CsiController(Mts::CsiFactory::newController()),  有问题 ??? 是否需要 安装 ???
